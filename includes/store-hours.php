<?php
	...
	date_default_timezone_set('America/Adelaide');
...
if($store_hours->is_open()) {
	echo "<strong class=\"open\">Yes, we're open! Today's hours are </strong>" . $store_hours->hours_today() . "<strong>.</strong>";
} else {
	echo "<strong class=\"closed\">Sorry, we're closed. Today's hours are</strong> " . $store_hours->hours_today() . "<strong>.</strong>";
}
